...
The Iowa Neighboring Towns Association of Homes (IOWANTAHOME), a regional realty group, has hired my company to build a model to predict house sale prices in the town of Ames, Iowa. In the course of realty listings, IOWANTAHOME collects 80 data pointes on each residence and they have provided me with training and test data sets of historical listings.
